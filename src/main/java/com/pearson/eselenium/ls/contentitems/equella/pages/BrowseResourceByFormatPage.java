...
public class BrowseResourceByFormatPage extends BasePageObject {
    ...
    /* UIElement declarations for BrowseResourceByFormatPage */
    private UIElement lnkImages = createElement(UIType.Xpath, "//a[text()='Images']");
    private UIElement lnkVideo = createElement(UIType.Xpath, "//a[text()='Video']");
    private UIElement lnkDocuments = createElement(UIType.Xpath, "//a[text()='Documents']");
    private UIElement lnkOthers = createElement(UIType.Xpath, "//a[text()='Other']");
    ...
    public EquellaImagesPage selectImages() throws Exception {
        logInstruction("LOG INSTRUCTION : CLICK ON IMAGES LINK");
        try {
    ...
    public EquellaVideoPage selectVideo() throws Exception {
        logInstruction("LOG INSTRUCTION : CLICK ON VIDEO LINK");
        try {
            frameSwitch.switchToAddLinkFrame();
    ...
    public EquellaDocumentPage selectDocuments() throws Exception {
        logInstruction("LOG INSTRUCTION : CLICK ON DOCUMENTS LINK");
        try {
            frameSwitch.switchToAddLinkFrame();
    ...
    /**
     * This method is used to click on Others link
     * 
     * @author Pratush.Manglik
     * @return EquellaDocumentPage
     * @throws Exception
    ...
    public EquellaDocumentPage selectOthers() throws Exception {
        logInstruction("LOG INSTRUCTION : CLICK ON OTHERS LINK");
        try {
            frameSwitch.switchToAddLinkFrame();
