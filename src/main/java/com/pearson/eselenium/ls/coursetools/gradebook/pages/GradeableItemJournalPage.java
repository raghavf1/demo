...
public class GradeableItemJournalPage extends BasePageObject {

	/* UIElement declarations for the GradeableItemJournalPage */
	...
	public GradeableItemJournalPage(UIDriver uiDriver) {
		super(uiDriver);
		logInstruction("############GradeableItemJournalPage######");
	}
	 ...
	 * @throws Exception
	 */
	public GradeableItemJournalPage enterNumericGrade(String entergrade)
			throws Exception {
		try {
	 ...
	 * @throws Exception
	 */
	public GradeableItemJournalPage enterLetterGrade(String lettergrade)
			throws Exception {
		try {
			logInstruction("LOG INSTRUCTION:ENTERING THE NUMERIC GRADE");
			frameSwitch.switchtopGeneralFrame();
	...
	/**
	 * Method to enter the grade of item type=journal
	 * 
	...
	public GradebookHomePage enterGradePoints(String lettergrade,
			...
			throws Exception {
		try {
			logInstruction("ENTERING GRADE FOR JOURNAL ITEM");
			frameSwitch.switchtopGeneralFrame();
			txtlettergrade.clearAndSendKeys(lettergrade);
